...
- upd: `Cli::input` new optional arg `$default` returned if
...
- new: `Pencil` cache original text for reversing it in certain
  situations
...
- new: `Cli::shellEnv` return enum Environment type: none, interactive,
  non-interactive
...
- other minor updates and fixes (mainly to code comments & variable
  typing)
